...
import static main.com.handu.scada.cache.MyCacheManager.DEVICE_DTU_INFO;
        ...
        if (enable) {
            ...
            try {
                ...
                if (infochanges != null && infochanges.size() > 0) {
                    ...
                    if (list != null) {
                        Vector<DeviceDtuCacheResult> results = MyCacheManager.getInstance().getDataByKey(DEVICE_DTU_INFO);
