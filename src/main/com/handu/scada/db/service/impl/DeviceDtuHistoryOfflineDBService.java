 ...
 */
public class DeviceDtuHistoryOfflineDBService extends BaseDBService implements IDBService {
    ...
    protected String startSql() {
        return " insert into device_history_staterecord(RecordId,DeviceTableName,DeviceId,State,Description,UnLineTime) values ";
    }
