 ...
 */
public class DeviceHmRealAfn0c25DBService extends BaseDBService implements IDBService {
    ...
    protected String startSql() {
        return " INSERT INTO device_hm_real_afn0c25( DtuAddress, ReadMeterTime, NowDayTotalActivePower," +
    ...
    protected String endSql() {
        return " on duplicate key update DtuAddress =values(DtuAddress), " +
    ...
    protected void jointSql() {
        if (dataList != null) {
            for (DeviceData deviceData : dataList) {
                ...
                if (afn0c25 != null) {
                    sb.append(getStartColumn(afn0c25.getDtuaddress()))
